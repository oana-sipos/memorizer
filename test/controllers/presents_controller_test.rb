...
class PresentsControllerTest < ActionController::TestCase
  ...
  test "should create present" do
    assert_difference('Present.count') do
      post :create, present: { giftee: @present.giftee, occasion: @present.occasion, present: @present.present }
    end
  ...
  test "should update present" do
    patch :update, id: @present, present: { giftee: @present.giftee, occasion: @present.occasion, present: @present.present }
    assert_redirected_to present_path(assigns(:present))
  end
